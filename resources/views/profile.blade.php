...
<main>
    ...
    <section class="contact-section">
        <div class="container">
            ...
            <div class="row">
                <div class="col-12">
                    <h2 class="contact-title">Change Profile</h2>
                </div>
                <div class="col-lg-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input class="form-control valid" name="name" id="name" value="{{$profile->name}}" type="text"  placeholder="Enter your name">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input class="form-control valid" name="email" value="{{$profile->email}}" id="email" type="email" placeholder = 'Enter email address'" placeholder="Email">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <input class="form-control" name="phone" value="{{$profile->phone}}" id="subject" type="text"  placeholder="Enter Phone">
                                </div>
                            </div>
                        </div>
